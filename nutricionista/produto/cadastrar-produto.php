<?php
    ...
    cabecalhoNutricionista('../../estilo/style.css', 'Cadastrar Produto', '../escola/', '../relatorio/', 'index.php', '../refeicao/', '../cardapio/', '../../login/logOut.php');
    ...
    Tipo de Produto  <?php
                                echo "<select name='tipoDeProduto'>";
                                    while($table = mysqli_fetch_array($query1)){
                                        ...
                                        echo "</select>";
                             ?><br><br>
                             <input type="submit" class="btn btn-dark" value="Cadastrar Produto">
</form>
