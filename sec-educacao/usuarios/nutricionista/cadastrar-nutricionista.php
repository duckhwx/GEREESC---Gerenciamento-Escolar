...
cabecalhoSecEdu('../../../estilo/style.css', 'Cadastrar Nutricionista', '../../escola/', '../cadastrar-usuarios.php', '../../produto/', '../../refeicao/', '../../cardapio/', '../../../login/logOut.php');
...
<form method="post" action="validar-nutricionista.php?acao=cadastrar">
    ...
    <input type="submit" class="btn btn-dark m-2" value="Cadastrar Nutricionista">
</form>
